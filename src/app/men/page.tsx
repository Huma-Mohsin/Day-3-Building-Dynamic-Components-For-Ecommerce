...
import FetchDataByMockAPI from '../components/FetchDataByMockAPI';
import MenProducts from '../components/ManCollection';
  ...
  return (
    <div className="grid grid-cols-12 px-4 md:px-10 py-20 relative">
      ...
      <div className="col-span-12 lg:col-span-9">
        ...
        <h1 className='text-black text-left text-3xl mb-4 font-bold '>Nike Collection</h1>
      <MenProducts/>
        <div>
